...
public class ConselhoTesteIntegracao {
    ...
    void setup() {
        ...
        turma.setCurso("TI");
        turma.setDataInicio(LocalDate.of(2025,11,17));
        turma.setDataFim(LocalDate.of(2025, 12, 10));
        turmaRepository.save(turma);

        aluno1 = new Aluno();
        aluno1.setMatricula("428");
        aluno1.setNome("Raquel");
        aluno1.setEmail("raquel@gmail.com");
        aluno1.setSenha("rara123");
        aluno1.setPrimeiroAcesso(true);
        aluno1.setRole(UsuarioRole.ALUNO);
        alunoRepository.save(aluno1);

        aluno2 = new Aluno();
        aluno2.setMatricula("740");
        aluno2.setNome("Julia");
        aluno2.setEmail("julia@gmail.com");
        aluno2.setSenha("juju123");
        aluno2.setPrimeiroAcesso(true);
        aluno2.setRole(UsuarioRole.ALUNO);
        alunoRepository.save(aluno2);

        pedagogico = new Pedagogico();
        pedagogico.setNome("Pedagógico Teste");
        pedagogico.setEmail("peda@gmail.com");
        pedagogico.setSenha("peda321");
