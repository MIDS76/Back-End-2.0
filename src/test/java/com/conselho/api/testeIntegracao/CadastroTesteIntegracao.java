...
public class CadastroTesteIntegracao {
    ...
    void deveCadastrarAlunoComSucesso() {
        AlunoRequestDTO request = new AlunoRequestDTO("1212", "Henrique", "henrique@gmail.com");
        ...
        assertThat(alunoBanco.getEmail()).isEqualTo("amanda@gmail.com");
    }
    ...
    void deveCadastrarProfessorComSucesso() {
        ...
        assertThat(prof.getNome()).isEqualTo("Vinicius");
        assertThat(prof.getEmail()).isEqualTo("vincius@gmail.com");
    }
