...
public class TurmaMapper {
    ...
    public TurmaResponseDTO paraResposta(Turma turma, List<String> nomesAlunos) {
        return new TurmaResponseDTO(turma.getId(), turma.getNome(), turma.getCurso(), nomesAlunos);
    }
